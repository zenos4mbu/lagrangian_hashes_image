...
from wisp.models.grids import OctreeGrid, CodebookOctreeGrid, TriplanarGrid, HashGrid, SplashGrid
...
class NeRFAppConfig:
    ...
    grid: autoconfig(OctreeGrid, SplashGrid.from_geometric, TriplanarGrid, CodebookOctreeGrid)
