...
gaussian_centers = read_obj("gaussian_positions_lv07_epoch_00301_MIC.obj")
...
# Normalize the density estimates for colorings
...
# Save to file
ply_data.write('MIC_5_05_CUDA_cold.ply')