...
#include "./ops/splash_interpolate.h"
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    ops.def("splash_interpolate_cuda", &splash_interpolate_cuda);
    ops.def("hashgrid_interpolate_backward_cuda", &hashgrid_interpolate_backward_cuda);
    ops.def("splash_interpolate_backward_cuda", &splash_interpolate_backward_cuda);
